...
class CaPOYO(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        # print('patches shape', patches.shape) # (batch, ????, 1) : 이 ????가 N_in이 아닐 때 문제가 발생하는 듯.
        ...
        ## (128, 8544, 128) - 중간 숫자는 계속 바뀜!! timeseries려나?
        ## temporal, spatial, spatiotemporal


        # latents
        latents = self.latent_emb(latent_index) # 정말... 그냥 껍데기 뿐임. 여기다가 채워넣는 것.
        # outputs
        ...
        ## 각 샘플을 가장 긴 샘플의 길이에 맞춰 0으로 패딩합니다. ㅇㅇ 패딩 맞음.
